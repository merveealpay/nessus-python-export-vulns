...
####
"""
* access_key ve secret_key 'i nessus -> my account -> API Keys 'ten generate edin ve asagidaki fonksiyona verin.
https://127.0.0.1:8834/#/settings/my-account/api-keys

* "pip install requests" ile requests modulunu kurun

* scriptin dizininde "python nes_1.py" komutunu calistirin.
